 ...
 *
 * @generated SignedSource<<e98663fc35b842c9430da7879897e655>>
 * @flow
...
return {
  ...
  "params": {
    ...
    "name": "RelayModernEnvironmentExecuteWithNestedStreamTestFeedQuery",
    "operationKind": "query",
    "text": "query RelayModernEnvironmentExecuteWithNestedStreamTestFeedQuery(\n  $enableStream: Boolean!\n) {\n  viewer {\n    ...RelayModernEnvironmentExecuteWithNestedStreamTestFeedFragment\n  }\n}\n\nfragment RelayModernEnvironmentExecuteWithNestedStreamTestFeedFragment on Viewer {\n  newsFeed(first: 10) {\n    edges @stream(label: \"RelayModernEnvironmentExecuteWithNestedStreamTestFeedFragment$stream$newsFeed\", if: $enableStream, initialCount: 0) {\n      cursor\n      node {\n        __typename\n        id\n        feedback {\n          actors @stream(label: \"RelayModernEnvironmentExecuteWithNestedStreamTestFeedFragment$stream$actors\", if: $enableStream, initialCount: 0) {\n            __typename\n            name\n            id\n          }\n          id\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();
